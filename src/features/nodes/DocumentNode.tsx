...
export default function DocumentNode({ id, data, selected }: NodeProps) {
  ...
  const renderContentPreview = () => {
    ...
    switch (contentType) {
      ...
      case 'image':
        return (
          <div className="bg-gray-50 dark:bg-gray-700 rounded p-3 max-w-dvw">
            <img
              src={imageUrl}
              alt={nodeData.fileName}
              className="max-w-dvw object-contain mx-auto rounded"
              onError={() => {
      ...
      case 'pdf':
        return (
          <div className="bg-gray-50 dark:bg-gray-700 rounded p-3 max-w-dvw">
            {/* PDF View Toggle */}
            <div className="flex items-center justify-start mb-3 w-full space-x-3">
              ...
              <div className="flex space-x-1">
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded ${pdfViewMode === 'text'
                ...
                <button
                  ...
                  className={`px-2 py-1 text-xs rounded ${pdfViewMode === 'pdf'
                    ? 'bg-blue-500 text-white'
                    : 'bg-gray-200 dark:bg-gray-600 text-gray-700 dark:text-gray-300'
                    }`}
                >
            ...
            {pdfViewMode === 'text' ? (
              ...
              documentContent && documentContent.length > 0 ? (
                <div className="max-h-lg max-w-lg overflow-y-auto text-sm text-gray-700 dark:text-gray-300">
                  <pre className="whitespace-pre-wrap font-sans">{documentContent.slice(0, 1000)}</pre>
                  {documentContent.length > 1000 && (
                    <p className="text-gray-500 dark:text-gray-400 mt-2 italic">
                      ... and {documentContent.length - 1000} more characters
  ...
  return (
    <>
      ...
      >
        {/* Minimized View */}
        {isMinimized && (
          <div className="p-3 w-80 max-w-md">
        ...
        {!isMinimized && (
          <div className="p-4">
            ...
            {/* Document Metadata */}
            <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400 mb-4 px-2 bg-gray-50 dark:bg-gray-700 rounded">
              <div className="flex items-center space-x-3">
