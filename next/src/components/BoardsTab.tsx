...
export default function BoardsTab({
  ...
  return (
    <div className="w-full mx-auto px-4 sm:px-6 lg:px-12 py-10">
      <div className="flex justify-between w-full gap-4 md:gap-12 mb-8">
        <Search
        ...
        >
          <span>new board</span>
          <svg width="44" height="44" className="mt-[1px] hidden md:block w-6 h-6 text-white" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
