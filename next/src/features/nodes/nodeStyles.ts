export function getNodeContainerClasses({
  ...
  const base = 'relative flex flex-col justify-start text-left p-3 bg-white dark:bg-gray-800 border border-2 border-transparent rounded-lg shadow-sm shadow-gray-400/20 dark:shadow-none group'
